...
- Shortlist ≥ 2: OBLIGATORIO present_product_cta(SELECT_FROM_LIST, productIds=[...ids de la tool]). Intro corta SIN listar platos, porciones ni precios (eso lo pone el sistema en los atajos). Si falta party size, la tool/Goal lo pide ANTES: no uses shortlist para saltear personas.
